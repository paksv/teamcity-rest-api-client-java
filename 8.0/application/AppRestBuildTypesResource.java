...
public interface AppRestBuildTypesResource {
    ...
    Response getInvestigations(@PathParam("btLocator") String btLocator);
    ...
    @Produces({"application/xml", "application/json"})
    @Path("/{btLocator}")
    Response serveBuildTypeXML(@PathParam("btLocator") String btLocator);
    ...
    Response serveBuildTypeParameters(@PathParam("btLocator") String btLocator, @QueryParam("locator") String locator);

    @PUT
    @Consumes({"application/xml", "application/json"})
    @Produces({"application/xml", "application/json"})
    @Path("/{btLocator}/parameters")
    Response changeBuildTypeParameters(@PathParam("btLocator") String btLocator);
    ...
    Response serveBuildTypeParameter(@PathParam("btLocator") String btLocator, @PathParam("name") String name);

    @PUT
    @Consumes("text/plain")
    @Produces("text/plain")
    @Path("/{btLocator}/parameters/{name}")
    Response putBuildTypeParameter(@PathParam("btLocator") String btLocator, @PathParam("name") String name);
    ...
    Response serveBuildTypeTemplate(@PathParam("btLocator") String btLocator);

    @PUT
    @Consumes("text/plain")
    @Produces({"application/xml", "application/json"})
    @Path("/{btLocator}/template")
    Response getTemplateAssociation(@PathParam("btLocator") String btLocator);
    ...
    Response serveBuildWithProject(@PathParam("btLocator") String btLocator, @PathParam("buildLocator") String buildLocator);
    ...
    Response serveBranches(@PathParam("btLocator") String btLocator);
