...
public interface AppRestBuildsResource {
    ...
    @Produces("*/*")
    @Path("/{buildLocator}")
    Response cancelBuild(@PathParam("buildLocator") String buildLocator, @QueryParam("fields") String fields);
    ...
    @Produces({"application/xml", "application/json" })
    @Path("/{buildLocator}")
    Response serveBuild(@PathParam("buildLocator") String buildLocator, @QueryParam("fields") String fields);
    ...
    Response getTests(@PathParam("buildLocator") String buildLocator, @QueryParam("fields") String fields);
    ...
    Response getProblems(@PathParam("buildLocator") String buildLocator, @QueryParam("fields") String fields);
    ...
    Response getCanceledInfo(@PathParam("buildLocator") String buildLocator, @QueryParam("fields") String fields);
    ...
    Response getArtifactContent(@PathParam("path") String path, @PathParam("buildLocator") String buildLocator, @QueryParam("resolveParameters") Boolean resolveParameters, @QueryParam("logBuildUsage") @DefaultValue("true") Boolean logBuildUsage);
    ...
    Response serveBuildRelatedIssuesOld(@PathParam("buildLocator") String buildLocator, @QueryParam("fields") String fields);

    @GET
    @Produces({"application/xml", "application/json" })
    @Path("/{buildLocator}/relatedIssues")
    Response serveBuildRelatedIssues(@PathParam("buildLocator") String buildLocator, @QueryParam("fields") String fields);
